...
public class ventana extends javax.swing.JFrame {
    ...
    public ventana() {
        ...
        for (int i = 0; i < clientes.length; i++) {
            ...
            clientes[i].setNombre("Don Pepito" + i);
            BDEnMemoria.conectar().insertar(clientes[i]);
        }

        //System.out.println(BDEnMemoria.conectar().seleccionar("Cliente", 0));
        //System.out.println(BDEnMemoria.conectar().seleccionar("Cliente"));
        BDEnMemoria.registrosATabla(this.jTable1, BDEnMemoria.conectar().seleccionarTodos("Cliente"));
